...
# for Qwen-Image-Edit-2509-Lightning
torchrun --nproc_per_node=$N_NPUS --master_addr $MASTER_ADDR --master_port $MASTER_PORT ../infer_image_gen.py \
    --model Qwen-Image-Edit-2509 \
    --pretrained_model_name_or_path ./models/Qwen-Image-Edit-2509 \
    --lora_path_list ./Qwen-Image-Lightning/Qwen-Image-Edit-2509/Qwen-Image-Edit-2509-Lightning-4steps-V1.0-bf16.safetensors \
    --fuse_lora \
